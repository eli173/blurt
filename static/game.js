    ...
    function cb(e) {
      ...
      if (t == "clue") {
        ...
        document.getElementById("ans").innerHTML =
          '<div class="answer-banner">Answer:</div><div class="answer-text">' +
          ans +
          "</div>";
        ...
        let d = document.createElement("div");
        d.innerHTML =
          '<div class="guess-entry"><div class="guesser">' +
          dat["name"] +
          ' guessed...</div><div class="guess">' +
          dat["guess"] +
          "</div></div>";
        gs.prepend(d);
      } else {
